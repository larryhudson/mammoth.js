...
function BodyReader(options) {
  ...
  function readDrawingElement(element) {
    ...
    var extent = element.getElementsByTagName("wp:extent")[0];
    var rawWidth = extent.attributes.cx;
    var rawHeight = extent.attributes.cy;

    var resultsToReturn = combineResults(
      blips.map(blip => readBlip(element, blip, rawHeight, rawWidth))
    );
  ...
  function readBlip(element, blip, rawHeight, rawWidth) {
  ...
  function readImage(imageFile, altText, relationshipId, rawHeight, rawWidth) {
